					...
					<div class="card card-custom card-stretch card-shadowless gutter-b">
						...
						<div class="card-header border-0 py-5">
							<h3 class="card-title align-items-start flex-column">
								...
								<span class="text-muted mt-3 font-weight-bold font-size-sm">Manage the Users</span>
							</h3>
								...
								<table class="table table-head-custom table-vertical-center"
									...
									<tbody>
										...
										<tr>
											...
											{{-- <img src="{{ asset('storage/'. $user->food_image) }}" class="h-75
											align-self-end" alt="" /> --}}
											{{-- </span>
																	</div>
																</td> --}}
											...
											<td>
												...
												<span
													class="text-dark-75 font-weight-bolder d-block font-size-lg badge badge-success">
													{{ $v}}</span>
												@endforeach
												@endif
											</td>
