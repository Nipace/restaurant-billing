                    ...
                    <div class="card card-custom card-stretch card-shadowless gutter-b pb-5">
                        ...
                        <div class="card-header border-0 py-5">
                            ...
                            <div class="card-toolbar">
                                <a href="{{route('report.currentUserCollection')}}" class="btn btn-sm btn-icon btn-light-primary">
                            ...
                            <div class="table-responsive">
                                <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
                                    <thead>
                                        ...
                                        <th style="width:25%">View Bill</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th class="{{ $order->status==1 ? 'cancel' : '' }}">{{ $order->token_no }}</th>
                                            <td class="{{ $order->status==1 ? 'cancel' : '' }}">{{ $order->grand_total }}</td>

                                            <td class="pr-0 text-left">
                                                <a href="#" data-toggle="modal" data-target={{"#detailModal".$order->id}} class="btn btn-primary btn-sm">
