        ...
        <div class="container">
            ...
            <div class="row mt-0 mt-lg-8">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-custom card-stretch card-shadowless gutter-b pb-4">
                        <!--begin::Header-->
                        ...
                        <div class="card-body py-0">
                                ...
                                <table class="table table-head-custom table-vertical-center"
                                    ...
                                    <thead>
                                        <tr class="text-left">
                                            ...
                                            <th style="min-width: 150px">Scheme Quantity</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-0">
                                                <div class="symbol symbol-50 symbol-light mt-1">
                                                    <span class="symbol-label">
                                                        <img src="{{ asset('storage/'. $scheme->food->food_image) }}"
                                            ...
                                            <td class="pl-0">
                                                <a href="#"
                                                    class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$scheme->food->name}}</a>
                                            </td>
                                            <td>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $scheme->quantity }}</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $scheme->start_date }}</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $scheme->end_date }}</span>
                                            </td>
                                            ...
                                            <td class="pr-0 text-right">
                                                ...
                                                {!! Form::open(['route' => ['schemes.destroy',$scheme->id], 'method' => 'delete','class'=>'float-right px-2']) !!}
                            ...
                            <tr>
                                ...
                                <td rowspan="6">No schemes to show</td>
                            </tr>
                            @endif
